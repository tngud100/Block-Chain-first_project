...
#1. docker-compose.yml -> 컨테이너 수행 -> net_basic 네트워크 생성
docker-compose -f docker-compose.yml up -d ca.example.com orderer.example.com peer0.org1.example.com peer0.org2.example.com cli #couchdb
docker ps -a
...
# -> cli working dir(/etc/hyperledger/configtx) mychannel.block 
